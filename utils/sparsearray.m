classdef sparsearray
    ...
    methods
        ...
        function obj = sparsearray(varargin)
            %sparsearray Construct an instance of this class
        ...
        %% ADD INDICES ALONG SUBINDEX CODINGS DIMENSION
        function obj = define_subindices(obj,d, S, Smax)
            if nargin<4
                Smax =  max(S(:));
            end
            ...
            switch s(1).type
                ...
                case '()'
                    ...
                    if ~issparse(obj.value) || length(s.subs)==1 % obj(ind1:ind3) or obj(:), return column vector
                        b = subsref(obj.value,s); %obj.value(s.subs{:});
                    else
